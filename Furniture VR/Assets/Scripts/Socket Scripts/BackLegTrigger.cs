...
//trigger for back fo chair, checks for "BackLeg" tag and handles checking of furniture parts for snapping
public class BackLegTrigger : MonoBehaviour
{
    [SerializeField]
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (!isSnapped)
        {
            ...
            if (other.gameObject.tag.Equals("BackLeg"))
            {
